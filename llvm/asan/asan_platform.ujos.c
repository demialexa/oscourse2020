...
platform_asan_init() {
    ...
    __nosan_memset(asan_internal_shadow_start, ASAN_GLOBAL_RZ, asan_internal_shadow_end - asan_internal_shadow_start);
    ...
    __nosan_memset((void *)asan_internal_shadow_extra_start, 0, asan_internal_shadow_extra_end - asan_internal_shadow_extra_start);
    __nosan_memset((void *)SANITIZE_USER_STACK_SHADOW_BASE, 0, SANITIZE_USER_STACK_SHADOW_SIZE);
    __nosan_memset((void *)SANITIZE_USER_FS_SHADOW_BASE, 0, SANITIZE_USER_FS_SHADOW_SIZE);
    __nosan_memset((void *)SANITIZE_USER_VPT_SHADOW_BASE, 0, SANITIZE_USER_VPT_SHADOW_SIZE);
}
